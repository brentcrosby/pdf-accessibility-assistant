...
The three public Caltrans documents below are **candidates awaiting owner approval**. Their source URLs and intended uses are recorded, but the PDF bytes and derived files have not been added to the repository.
...
- **Selection status:** Candidate — awaiting owner approval
...
- **Retrieved:** Not yet downloaded
- **SHA-256:** Pending approved download
...
Before downloading or transforming the candidates:

- [ ] Owner approves CT-001, CT-002, and CT-003 or requests replacements.
